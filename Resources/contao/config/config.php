 ...
 */
$GLOBALS['TL_CTE']['futuraweb']['envelopestart']    = \FuturaWeb\Envelope\Classes\Contao\Elements\ContentEnvelopeStart::class;
$GLOBALS['TL_CTE']['futuraweb']['envelopeend']      = \FuturaWeb\Envelope\Classes\Contao\Elements\ContentEnvelopeEnd::class;


/**
 * WRAPPER ELEMENTS
 */
$GLOBALS['TL_WRAPPERS']['start'][]  = 'envelopestart';
$GLOBALS['TL_WRAPPERS']['stop'][]   = 'envelopeend';
